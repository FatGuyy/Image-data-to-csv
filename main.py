...
def main(source, option_number, CSV_folder_path):
    ...
    if option_number == 1:
        ...
        write_list_to_csv_column('reg Boob', option_2.option_2(
            FILE_NAMES), folder_path=CSV_folder_path)
        ...
        write_list_to_csv_column('REG', option_3.option_3(
            FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_2nd_csv_column(
            '3rd-option-2nd', option_3.option_3_2nd_csv(FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_3rd_csv(
        ...
        write_list_to_csv_column('trans r', option_5.option_5(
            FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_2nd_csv_column(
            '5th-option-2nd', option_5.option_5_2nd_csv(FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_3rd_csv(
            '5th-option-3rd', option_5.option_5_3rd_csv(FILE_NAMES), folder_path=CSV_folder_path)
    elif option_number == 6:
        write_list_to_csv_column('trans boob', option_6.option_6(
            FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_2nd_csv_column(
            '6th-option-2nd', option_6.option_6_2nd_csv(FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_3rd_csv(
            '6th-option-3rd', option_6.option_6_3rd_csv(FILE_NAMES), folder_path=CSV_folder_path)
        ...
        write_list_to_2nd_csv_column(
            '11th-option-2nd', option_11.option_11_2nd_csv(FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_3rd_csv(
        ...
        write_list_to_2nd_csv_column(
            '13th-option-2nd', option_13.option_13_2nd_csv(FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_3rd_csv(
        ...
        write_list_to_2nd_csv_column(
            '14th-option-2nd', option_14.option_14_2nd_csv(FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_3rd_csv(
        ...
        write_list_to_2nd_csv_column(
            '16th-option-2nd', option_16.option_16_2nd_csv(FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_3rd_csv(
        ...
        write_list_to_2nd_csv_column(
            '17th-option-2nd', option_17.option_17_2nd_csv(FILE_NAMES), folder_path=CSV_folder_path)
        ...
        write_list_to_csv_column('Gay Boob', option_20.option_20(
            FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_2nd_csv_column(
            '20th-option-2nd', option_20.option_20_2nd_csv(FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_3rd_csv(
        ...
        write_list_to_csv_column('gay REG', option_21.option_21(
            FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_2nd_csv_column(
            '21th-option-2nd', option_21.option_21_2nd_csv(FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_3rd_csv(
        ...
        write_list_to_csv_column('playboy REG', option_24.option_24(
            FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_2nd_csv_column(
            '24th-option-2nd', option_24.option_24_2nd_csv(FILE_NAMES), folder_path=CSV_folder_path)
        write_list_to_3rd_csv(
            '24th-option-2nd', option_24.option_24_3rd_csv(FILE_NAMES), folder_path=CSV_folder_path)
        ...
        write_list_to_3rd_csv('25th-option-3rd', option_25.option_25_3rd_csv(
            FILE_NAMES, inventory_csv_path=inventory_csv_path), folder_path=CSV_folder_path)
    elif option_number == 26:
        inventory_csv_path = input("Enter the inventory sheet path : ")
        # inventory_csv_path = "/home/fatguy/Desktop/codes/fiver/image_to_csv/new sample inventory.csv"
        option_26.option_26(FILE_NAMES=FILE_NAMES, csv_folder_path=CSV_folder_path,
                            inventory_csv_path=inventory_csv_path)
        write_list_to_3rd_csv('26th-option-3rd', option_26.option_26_3rd_csv(
            FILE_NAMES, inventory_csv_path=inventory_csv_path), folder_path=CSV_folder_path)
        ...
        option_27.option_27(FILE_NAMES=FILE_NAMES, csv_folder_path=CSV_folder_path,
                            inventory_csv_path=inventory_csv_path)
        write_list_to_3rd_csv('27th-option-3rd', option_27.option_27_3rd_csv(
            FILE_NAMES, inventory_csv_path=inventory_csv_path), folder_path=CSV_folder_path)
        ...
        option_28.option_28(FILE_NAMES=FILE_NAMES, csv_folder_path=CSV_folder_path,
                            inventory_csv_path=inventory_csv_path)
        write_list_to_3rd_csv('28th-option-3rd', option_28.option_28_3rd_csv(
            FILE_NAMES, inventory_csv_path=inventory_csv_path), folder_path=CSV_folder_path)
        ...
        option_29.option_29(FILE_NAMES=FILE_NAMES, csv_folder_path=CSV_folder_path,
                            inventory_csv_path=inventory_csv_path)
        write_list_to_3rd_csv('29th-option-3rd', option_29.option_29_3rd_csv(
            FILE_NAMES, inventory_csv_path=inventory_csv_path), folder_path=CSV_folder_path)
        ...
        option_30.option_30(FILE_NAMES=FILE_NAMES, csv_folder_path=CSV_folder_path,
                            inventory_csv_path=inventory_csv_path)
        write_list_to_3rd_csv('30th-option-3rd', option_30.option_30_3rd_csv(
            FILE_NAMES, inventory_csv_path=inventory_csv_path), folder_path=CSV_folder_path)
    else:
