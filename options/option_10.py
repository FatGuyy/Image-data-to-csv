...
def option_10(FILE_NAMES, csv_folder_path):
    ...
    for i in FILE_NAMES:
        ...
        #sku list
        sku = First_name + Last_name[0] + f"{Last_4}" + date1 + "tsrc3"  # The end of sku
        sku_list.append(sku)
...
def option_10_2nd_csv(FILE_NAMES, inventory_csv_path):
    '''
    ...
    for i in FILE_NAMES:
        ...
        # sku list
        sku = First_name + Last_name[0] + f"{Last_4}" + date1 + "tsrc3"
        sku_list.append(sku)
