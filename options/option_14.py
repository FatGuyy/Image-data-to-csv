"""
This file gets the 14th option.
"""
import os
import csv
import pandas as pd
...
def option_14(FILE_NAMES, csv_folder_path):
    price = []
    Sale_price = []
    photo_list = []
    video_list = []
...
def option_14_2nd_csv(FILE_NAMES, inventory_csv_path):
    '''
...
def option_14_3rd_csv(FILE_NAMES):
    column_a = []
