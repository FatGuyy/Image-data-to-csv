"""
This file gets the 19th option. (back to one name only)
"""
...
def option_19(FILE_NAMES):
    ...
    name_list = []
    name_link = []
    product_name = "{} {} signed Gay Porn Star 8×10 photo -PROOF- -CERTIFICATE- (A{})"
    date1 = _date()
    ...
    for i in FILE_NAMES:
        ...
        #sku list
        sku = First_name + Last_name[0] + f"{Last_4}" + date1 + "gx"
        sku_list.append(sku)
