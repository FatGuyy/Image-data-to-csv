"""
This file gets the 20th option. (back to one name only)
"""
import csv
...
def option_20(FILE_NAMES):
    ...
    global name_list
    name_link = []
    product_name = "{} {} signed gay model B 8x10 Photo -PROOF- -CERTIFICATE- (A{})"
    date1 = _date()
    ...
    for i in FILE_NAMES:
        ...
        #sku list
        sku = First_name + Last_name[0] + f"{Last_4}" + date1 + "grb"
        sku_list.append(sku)
...
def option_20_2nd_csv(FILE_NAMES, inventory_csv_path):
    '''
...
def option_20_3rd_csv(FILE_NAMES):
    column_a = []
