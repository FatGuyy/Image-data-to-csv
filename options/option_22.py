"""
This file gets the 22th option. (back to one name only)
"""
...
def option_22(FILE_NAMES):
    ...
    name_list = []
    name_link = []
    product_name = "{} {} signed Playboy 8x10 photo -PROOF- -CERTIFICATE- (A{})"
    date1 = _date()
    ...
    for i in FILE_NAMES:
        ...
        #sku list
        sku = First_name + Last_name[0] + f"{Last_4}" + date1 + "px"
        sku_list.append(sku)
