...
def option_24(FILE_NAMES):
    ...
    global name_list
    name_link = []
    product_name = "{} {} signed Playboy model 8x10 Photo -PROOF- -CERTIFICATE- (A{})"
    date1 = _date()
    ...
    for i in FILE_NAMES:
        ...
        #sku list
        sku = First_name + Last_name[0] + f"{Last_4}" + date1 + "pr"
        sku_list.append(sku)
...
def option_24_2nd_csv(FILE_NAMES, inventory_csv_path):
    '''
...
def option_24_3rd_csv(FILE_NAMES):
    column_a = []
